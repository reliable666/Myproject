 ...
 */
public class MyHotDetailsPagerAdapter extends PagerAdapter {
    private ArrayList<ImageView> list;
    private SelectCarouselBean selectCarouselBean;
    private Context context;


    public MyHotDetailsPagerAdapter(Context context) {
    ...
    public MyHotDetailsPagerAdapter(ArrayList<ImageView> list) {
        this.list = list;
    }
